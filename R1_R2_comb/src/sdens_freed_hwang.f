...
c
      ...
      double precision scale, jomega, jomega2, jomega0
      double precision o2, ou2, fac
...
c     fm=fm*2*4096/(4.96735e-9)**3
     ...
     .           (3.0*jomega0+5.0*(jomega+deltaj)+2.0*(jomega2+deltaj2))
     .           *fac/10.0d0,
     .           (jomega+4.0d0*jomega2)*fac/5.0d0,
     .           (3.0d0*jomega0+5.0*jomega+2.0d0*jomega2)*fac/10.0d0,    
     .           (deltaj+4.0d0*deltaj2)*fac/5.0d0,
     .           (5.0*deltaj+2.0d0*deltaj2)*fac/10.0d0,            
